...
El costo total de propiedad o costo total de propieda (proveniente del término anglosajón total cost of ownership o TCO), es un método de cálculo diseñado para ayudar a los usuarios y a los gestores empresariales a determinar los costes directos e indirectos, así como los beneficios, relacionados con un producto o sistema. 

## Uso TCO
Se usa especificamente para la compra de equipos o programas informáticos, y de modo creciente para el cálculo económico de soluciones energéticas sostenibles.
...
El análisis del coste total de propiedad fue creado por el Grupo Gartner en 1987 y desde entonces se ha desarrollado en diferentes metodologías y herramientas de software. Por ejemplo, la compra de un ordenador puede incluir la compra en sí misma, reparacione, mantenimiento, actualizaciones, servicios y soporte, redes, seguridad, formación de usuarios y costes de licencias.
